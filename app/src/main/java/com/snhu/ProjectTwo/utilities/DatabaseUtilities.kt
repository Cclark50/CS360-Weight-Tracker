...
suspend fun AddNewWeight(id: Long, date: Long, weight: Float, userInfoDao: UserInfoDao): Long{
...
suspend fun SetGoal(id: Long, start: Float, goal: Float, goalDao: GoalDao): Long{
